      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="relative px-6 py-14 sm:px-12 sm:py-16 lg:px-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
              ...
              <div className="text-center">
                ...
                <h3 className="text-sm font-semibold text-white mb-1">Automation & Execution</h3>
                <p className="text-xs text-white/80">Execute signals with discipline and control</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm ring-1 ring-gray-200 p-6">
              <h3 className="text-base font-semibold text-gray-900">Execution workflow</h3>
              <ul className="mt-3 space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2"><span className="mt-1 h-2 w-2 rounded-full bg-cyan-500"></span><span>Connect exchange keys and enable execution</span></li>
                <li className="flex items-start gap-2"><span className="mt-1 h-2 w-2 rounded-full bg-cyan-500"></span><span>Keep actions consistent with your strategy rules</span></li>
                <li className="flex items-start gap-2"><span className="mt-1 h-2 w-2 rounded-full bg-cyan-500"></span><span>Monitor performance and iterate confidently</span></li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-3xl shadow-sm ring-1 ring-gray-200 p-8">
            ...
            <ol className="mt-4 space-y-4 text-sm text-gray-700">
              <li className="flex gap-3"><span className="mt-1 h-2 w-2 rounded-full bg-blue-600"></span><span>Open <Link to="/simulator" className="text-blue-600 hover:text-blue-800 font-medium">Strategies</Link> and set exchange, symbol, timeframe.</span></li>
        ...
        <section className="mt-12 relative overflow-hidden rounded-3xl">
          ...
          <div className="relative p-8 sm:p-10 text-center">
            ...
            <p className="mt-2 text-white/90 max-w-2xl mx-auto text-sm sm:text-base">Open strategies or browse ML models. When ready, connect your exchange and execute with confidence.</p>
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link to="/simulator" className="px-5 py-3 rounded-xl bg-white text-slate-900 font-semibold hover:bg-blue-50 transition-all shadow">Open Strategies</Link>
